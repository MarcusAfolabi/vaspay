<section class="auto hidden">
    ...
    <form id="entryForm" class="mt-4 mb-8">
        <div class=" flex items-center">
            <div>
                <h3 class="text-purple-900 text-sm sm:text-sm font-normal appearance-none">Select Country</h3>
            </div>
            <div class="ml-auto">
        ...
        <div class=" flex items-center mt-4">
            <div>
            <h3 class="text-purple-900 text-sm sm:text-sm font-normal appearance-none">Network Provider</h3></div>
            <!-- <div class="ml-auto">
                <button type="reset" class="text-sm font-medium text-red-500">CLEAR ENTRY</button>
            </div> -->
        </div>
