    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8 border-b border-purple-200 pb-8">
        <div>
            ...
            <div class="border border-purple-200 rounded-lg py-4 px-4 space-y-4">
                <div class="flex justify-between">
                    <p class="text-base font-normal text-black flex items-center">
                    <img src="{{ asset('img/cable/gotv.svg') }}" class="pr-2" /> 09952361689</p>
        ...
        <div>
            ...
            <div class="border border-purple-200 rounded-lg py-4 px-4 space-y-4">
                <div class="flex justify-between">
                    <p class="text-base font-normal text-black flex items-center">
                    <img src="{{ asset('img/cable/dstv.svg') }}" class="pr-2" /> 09952361689</p>
                    <p class="flex items-center text-end justify-end">
        ...
        <div class="flex items-center justify-center min-h-screen">
            ...
            <div class="bg-white w-[360px] lg:w-[470px] rounded-lg px-6 py-6   ">
                ...
                <div class=" mt-4 mb-4">
                    ...
                    <div class="mt-2">
                        <input type="tel" name="amount" placeholder="₦" id="amountInput" oninput="formatAmount()" required class="block w-full appearance-none text-purple-500   bg-purple-100 border border-transparent hover:border-purple-300 px-4 h-12 pr-8 rounded leading-tight focus:outline-none focus:border-purple-500 focus:ring-0">
