<section class="one mt-7">
    <div class="flex items-center mt-8">
        <div>
            <h3 class="text-sm font-semibold">BENEFICIARIES</h3>
        </div>
    ...
    <div class="flex mt-4 items-center w-full rounded-lg bg-transparent">
        <div id="slider" class="snap-x flex space-x-4 text-sm">
            ...
            <div class="pl-4 flex flex-col justify-center items-center">
                <!-- Added 'flex items-center' class -->
                <img src="{{ asset('img/cable/dstv.svg') }}" class="" />
                <!-- Added 'mr-2' class for some spacing -->
                <p class="text-center">Office Space</p>
            </div>
            <div class="pl-4 flex flex-col justify-center items-center">
                <!-- Added 'flex items-center' class -->
                <img src="{{ asset('img/cable/gotv.svg') }}" class="" />

                <!-- Added 'mr-2' class for some spacing -->
                <p class="text-center">Home 1</p>
            </div>
            <div class="pl-4 flex flex-col justify-center items-center">
                <img src="{{ asset('img/cable/dstv.svg') }}" class="" />
                <p class="text-center">Home 2</p>
            </div>
    ...
    <div class="mb-5  flex items-center mt-8">
        <div>
            <h3 onclick="openNewNumberModal()" class="text-sm font-semibold mb-3">NEW NUMBER</h3>
        </div>
        <div class="ml-auto">
        </div>
    </div>
    ...
    <form id="entryForm" class="mt-8 mb-8">
        <div class="mb-2 flex items-center">
            <div>
                <h3 class="text-sm font-normal appearance-none">Service Provider</h3>
            </div>
            <div class="ml-auto">
        ...
        <div class="sm:col-span-2 w-full mt-2">
            <div class="inline-block relative w-full">
                <select required name="provider" class="custom-select block w-full appearance-none text-purple-500 bg-purple-100 border border-transparent hover:border-purple-300 px-4 h-12 pr-8 rounded leading-tight focus:outline-none focus:ring-0">
                    <option value="family">Select service provider</option>
                </select>
        ...
        <div class="mt-4 flex items-center">
            <div>
                <h3 class="text-sm font-normal">Package</h3>
            </div>
            <div class="ml-auto">
                <button type="button" onclick="populatePhoneNumber()" class="text-sm font-medium text-purple-500">RECHARGE SELF</button>
        ...
        <div class="sm:col-span-2 w-full mt-2">
            <div class="inline-block relative w-full">
                <select required name="provider" class="custom-select block w-full appearance-none text-purple-500 bg-purple-100 border border-transparent hover:border-purple-0 px-4 h-12 pr-8 rounded leading-tight focus:outline-none focus:ring-0">
                    <option value="family">Select a package</option>
        ...
        <div class="sm:col-span-2 w-full mt-4 text-sm font-normal">
            ...
            <div class="sm:col-span-2 w-full mt-2">
                <div class="inline-block relative w-full">
                    <input type="tel" maxlength="11" name="phone" id="phoneNumberInput" value="Enter smart card number" class="block w-full appearance-none text-purple-500 bg-purple-100 border border-transparent
        ...
        <div class="sm:col-span-2 w-full mt-4 text-sm font-normal">
            ...
            <div class="sm:col-span-2 w-full mt-2">
                <div class="inline-block relative w-full">
                    <input type="tel" maxlength="11" name="phone" id="phoneNumberInput" value="₦ 2000" class="block w-full appearance-none text-purple-500 bg-purple-100 border border-transparent
                    hover:border-purple-300 px-4 h-12 pr-8 rounded leading-tight focus:outline-none focus:border-purple-500 focus:ring-0">
                </div>
                <p>Balance: ₦88,780.50</p>
        ...
        <div class="mt-5 border-b border-purple-200 pb-8">
            <label class="flex items-center">
                <input id="check-benenficiary" type="checkbox" class="checkbox-custom">
                <span class="px-2 py-3 sm:text-md"></span>
                <p class="text-sm">Save as Beneficiary</p>
            </label>
        </div>
