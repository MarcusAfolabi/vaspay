<section class="one mt-7">
    <div class="flex items-center mt-8">
        ...
        <!-- <div class="ml-auto">
            <a href="#" class="text-sm font-medium text-purple-400">SEE ALL</a>
        </div> -->
    </div>
    ...
    <form id="entryForm" class="mt-8 mb-8">
        ...
        <div class="mt-4 flex items-center">
            ...
            <div class="ml-auto">
                <button type="button" onclick="populatePhoneNumber()" class="text-sm font-medium text-purple-700">RECHARGE SELF</button>
