...
<section class="auto hidden">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8 border-b border-purple-200 pb-8">
        <div>

            <div class="border border-purple-200 rounded-lg py-4 px-4 space-y-4">
                <div class="flex justify-between">
                    <p class="text-base font-normal text-black flex items-center"> <img src="{{ asset('img/electricity/ibedc.svg') }}" class="pr-2" /> 12052361689</p>
                ...
                <div class="flex justify-end items-center gap-4">
                    <button id="edit-Data-Auto" class="rounded-lg bg-purple-50 py-2 px-3 text-purple-500 text-sm font-semibold">Edit</button>
                    <button id="remove-auto" class="rounded-lg text-purple-500 py-2 px-2 bg-purple-200 text-sm font-semibold">Remove</button>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="border border-purple-200 rounded-lg py-4 px-4 space-y-4">
                <div class="flex justify-between">
                    <p class="text-base font-normal text-black flex items-center"> <img src="{{ asset('img/electricity/ibedc.svg') }}" class="pr-2" /> 12352361689</p>
                    <p class="flex items-center text-end justify-end">
                ...
                <div class="flex justify-end items-center gap-4">
                    <button class="rounded-lg bg-purple-50 py-2 px-3 text-purple-500 text-sm font-semibold">Edit</button>
                    <button class="rounded-lg text-purple-500 py-2 px-2 bg-purple-200 text-sm font-semibold">Remove</button>
                </div>
            </div>
        </div>
        ...
        <div>
            <div class="border border-purple-200 rounded-lg py-4 px-4 space-y-4">
                <div class="flex justify-between">
                    <p class="text-base font-normal text-black flex items-center"> <img src="{{ asset('img/electricity/ibedc.svg') }}" class="pr-2" /> 66252361689</p>
                    <p class="flex items-center text-end justify-end">
                        <input type="checkbox" id="mySwitch" class="switch-input">
                        <label for="mySwitch" class="switch-label"></label>
                    </p>
    ...
    <div id="remove-modal" class="fixed hidden inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div class="flex items-center justify-center min-h-screen">
            ...
            <div class="bg-white rounded-lg p-8 flex flex-col w-[380px] md:w-full items-center justify-center">
                ...
                <div class="text-center justify-center w-full border-b border-purple-200 pb-6">
                ...
                <div class="mt-6 flex gap-4 justify-between items-center">
                    ...
                    <button id="cancel-auto-modal" class="bg-purple-200 text-sm md:text-base text-black py-2.5 px-8 md:px-12 md:py-3 rounded-lg ">No, cancel</button>
    ...
    <div id="edit-DataAuto-Modal" class="fixed hidden inset-0  items-center justify-center bg-black bg-opacity-50">
        <div class="flex items-center justify-center min-h-screen">
            ...
            <div class="bg-white w-[360px] lg:w-[470px] rounded-lg px-6 py-6   ">
                ...
                <!-- Modal header -->
                <h2 class="text-2xl font-medium border-b border-purple-200 pb-6">Edit auto top-up</h2>
                <div class="sm:col-span-2 mt-6">
                    <label for="gender" class="block text-sm font-normal leading-6 text-purple-900">Network Provider</label>
                    <div class="mt-2">
                        <div class="relative">
                            <select style="color: #808080;" class="my-select block w-full appearance-none bg-purple-100 border border-transparent hover:border-purple-300 px-4 py-3 pr-8 rounded leading-tight focus:outline-none focus:border-purple-500 focus:ring-0">
                ...
                <div class=" mt-4 mb-4">
                    <label for="email" class="block text-sm font-normal leading-6 text-purple-900">Amount</label>
                    <div class="mt-2">
                        <input type="tel" name="amount" placeholder="₦2,000" id="amountInput" oninput="formatAmount()" required class="block w-full appearance-none text-purple-500   bg-purple-100 border border-transparent hover:border-purple-300 px-4 h-12 pr-8 rounded leading-tight focus:outline-none focus:border-purple-500 focus:ring-0">
                        <p class="text-sm">Balance: ₦88,780.50</p>
                    </div>
                </div>

                <div class="flex items-start justify-start gap-40 mb-2">
                    <label class="block text-sm font-normal leading-6 text-purple-900">Frequency</label>
                    <label class="block text-sm font-normal leading-6 text-purple-900">Start Date</label>
                </div>

                <div class="grid grid-cols-2 justify-between items-center gap-4">
                    <div class="flex bg-purple-100 rounded-lg ">
                        ...
                        <div class="mt-2.3 flex-grow">
                            <div class="relative">
                                ...
                                class="rounded-lg block border-0 px-4 py-3 border-b border-transparent bg-purple-100 focus:border-purple-500
                        ...
                        <div class="mt-2.3 flex-none">
                            <div class="text-center h-full border-l border-purple-300"></div>
                        </div>
                        <div class="mt-2.3 flex-grow">
                            <div class="relative rounded-r-lg">
                                <select  class="my-select text-sm md:text-sm block w-full appearance-none bg-purple-100 border border-transparent hover:border-purple-0 px-4 py-3 leading-tight focus:outline-none focus:ring-0">
                                    <option value="week">days</option>
                                    <option value="week">week</option>
                                    <option value="week">week</option>
                                </select>
                                <div class="pointer-events-none absolute inset-y-0 -right-2 md:right-0 flex items-center px-4 text-purple-500">
                    ...
                    <div class="mt-2.3 flex-grow">
                        <div class="relative flex justify-center items-center">
                            <input type="text" minlength="3" maxlength="255" name="second_name" id="second_name" required autocomplete="given-name" class="rounded-lg block w-full border-0 px-4 py-3 border-b border-transparent bg-purple-100 focus:border-purple-500 focus:ring-0 sm:text-md" placeholder="2 May 2023">
                ...
                <div class="w-full border-b border-purple-200 pb-6"> </div>

                <div class="flex gap-3 w-full justify-between items-center mt-4">
                    <button id="cancel-edit" class="bg-purple-100 w-full text-dark rounded-lg px-4 py-3">No, cancel</button>
                    <button class="bg-purple-500 w-full text-white rounded-lg px-4 py-3">Save</button>
