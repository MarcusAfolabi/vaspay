...
<div class="sm:hidden fixed bottom-0 left-0 right-0 bg-gray-50">
    <div class="flex text-center items-center justify-between py-2 w-full">
        ...
        <a href="{{ route('index') }}" class="text-center text-xs font-medium mr-4 flex flex-col items-center">
            ...
            </svg> <span class="{{ request()->routeIs('index') ? 'text-purple-700' : 'text-purple-700' }} relative">
                Account
                <span class="absolute bottom-0 left-1/2 transform -translate-x-1/2 h-0.5 w-4 bg-purple-500"></span>
            </span>
        </a>
        ...
        <a href="{{ route('index') }}" class="text-center text-xs font-medium mr-4 flex flex-col items-center">
            ...
            <span class="{{ request()->routeIs('index') ? 'text-purple-700' : 'text-gray-500' }} relative">
                Account
            </span>
        </a>
        @endif
