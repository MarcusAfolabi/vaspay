...
<div class="sm:hidden fixed bottom-0 left-0 right-0 bg-gray-50">
    <div class="flex text-center items-center justify-between py-2 w-full">
        ...
        <a href="{{ url('welcome') }}" class="text-center text-xs font-medium ml-4 flex flex-col items-center">
            <img class="mb-1" src="{{ asset('img/menu_icon/home_filled.svg') }}" alt="Home Icon" />
            <span class="{{ request()->routeIs('welcome') ? 'text-green-500' : 'text-green-500' }} relative">
                Home
                <span class="absolute bottom-0 left-1/2 transform -translate-x-1/2 h-0.5 w-4 bg-green-500"></span>
            </span>
        </a>
        @else
        <a href="{{ url('welcome') }}" class="text-center text-xs font-medium ml-4 flex flex-col items-center">
            <img class="mb-1" src="{{ asset('img/menu_icon/home.svg') }}" alt="Home Icon" />
            <span class="{{ request()->routeIs('welcome') ? 'text-green-500' : 'text-gray-500' }} relative">
                Home
            </span>
        </a>
        @endif
        ...
        <a href="{{ url('saving') }}" class="text-center text-xs font-medium ml-3 flex flex-col items-center">
            ...
            <span class="{{ request()->routeIs('saving.index') ? 'text-green-500' : 'text-green-500' }} relative">
                Reseller
                <span class="absolute bottom-0 left-1/2 transform -translate-x-1/2 h-0.5 w-4 bg-green-500"></span>
            </span>
        </a>
        ...
        <a href="{{ url('saving') }}" class="text-center text-xs font-medium ml-3 flex flex-col items-center">
            ...
            <span class="{{ request()->routeIs('saving.index') ? 'text-green-500' : 'text-gray-500' }} relative">
                Reseller
            </span>
        </a>
        @endif
        ...
        <a href="{{ url('vas') }}" class="text-center text-xs font-medium ml-3 flex flex-col items-center">
            ...
            <span class="{{ request()->routeIs('vas.index') ? 'text-green-500' : 'text-green-500' }} relative">
                VAS
                <span class="absolute bottom-0 left-1/2 transform -translate-x-1/2 h-0.5 w-4 bg-green-500"></span>
            </span>
        </a>
        ...
        <a href="{{ url('vas') }}" class="text-center text-xs font-medium ml-3 flex flex-col items-center">
            ...
            <span class="{{ request()->routeIs('vas.index') ? 'text-green-500' : 'text-gray-500' }} relative">
                VAS
            </span>
        </a>
        @endif
        ...
        <a href="{{ route('account.index') }}" class="text-center text-xs font-medium mr-4 flex flex-col items-center">
            ...
            </svg> <span class="{{ request()->routeIs('account.index') ? 'text-green-500' : 'text-green-500' }} relative">
                Account
                <span class="absolute bottom-0 left-1/2 transform -translate-x-1/2 h-0.5 w-4 bg-green-500"></span>
            </span>
        </a>
        ...
        <a href="{{ route('account.index') }}" class="text-center text-xs font-medium mr-4 flex flex-col items-center">
            ...
            <span class="{{ request()->routeIs('account.index') ? 'text-green-500' : 'text-gray-500' }} relative">
                Account
            </span>
        </a>
        @endif
